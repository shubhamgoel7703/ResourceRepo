...
public class EmployeeBean {
	...
	public String toString() {
		return "EmployeeBean [project=" + project + ", level=" + level + ", resourceType=" + resourceType
				...
				+ contactDetails + ", lockStartDate=" + lockStartDate + ", billableDate=" + billableDate
				+ ", RollOffDate=" + RollOffDate + ", joinDate=" + joinDate + ", dob=" + dob + ", gcp=" + gcp + "]";
	}
